...
public class Test4 {
	...
	public void beforetest() {
		...
		htmlextent = new ExtentHtmlReporter("D://Automation_Reports//extentdemo.html");
	...
	public void testcase2() {
		...
		try {
			log.pass("details", MediaEntityBuilder.createScreenCaptureFromPath(captureScreen()).build());
...
//			log.log(Status.PASS, "Passed test 2" + log.addScreenCaptureFromPath(captureScreen()));
	...
	public String captureScreen() throws IOException {
		...
		String dest = "D://Automation_Reports//screenshots//Screenshot_" + getcurrentdateandtime() + ".png";
