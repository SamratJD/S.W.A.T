...
## PhantomJS (optional)
* For running headless browser tests in S.W.A.T please set the Environment path to the **phantomjs.exe** file provided in the `Drivers` folder.
...
| isSelected(By by)                                                                          | By objLocator                                                  | To verify if the checkbox/radiobutton is selected or not                       |
| selectDropdownByValue(By by, String value)                                                 | By objLocator, String value                                    | To select from a drop down by using value                                      |
| selectDropdownByIndex(By by, int index)                                                    | By objLocator, int index                                       | To select from a drop down by using index                                      |
| selectDropdownByText(By by, String text)                                                   | By objLocator, String text                                     | To select from a drop down by using text                                       |
| verifyText(By by, String expected)                                                         | By objLocator, String expected                                 | To verify the text of a label etc.                                             |
| clickOnElement(String elementName, By by)                                                  | String elementName, By objLocator                              | To click on a link/button etc.                                                 |
| verifyElementPresent(String elementName, By by)                                            | String elementName, By objLocator                              | To verify if the element is presenet in the web page or not                    |
| setText(By by, String text)                                                                | By objLocator, String text                                     | To enter text in a textbox                                                     |
| setSecureText(By by, String encodedtext)                                                   | By objLocator, String encodedtext                              | To enter encoded text in a textbox                                             |
| waitForElementPresent(By by, int timeToWait)                                               | By objLocator, int timeToWait                                  | To wait for a particular web element to be present in web page                 |
| waitForPageToLoad()                                                                        |                                                                | To wait for a web page to load                                                 |
| acceptAlert(By by)                                                                         | By objLocator                                                  | To accept an alert pop-up                                                      |
| verifyAlertText(By by, String expectedText)                                                | By objLocator, String expectedText                             | To verify text in an alert pop-up                                              |
| enterTextAlert(By by, String input)                                                        | By objLocator, String input                                    | To enter text in an alert pop-up                                               |
| switchWindow()                                                                             |                                                                | To switch to child window                                                      |
| switchFrame(By by)                                                                         | By objLocator                                                  | To switch to frame containing the web element                                  |
